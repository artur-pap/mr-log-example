package ru.apapikyan.learn.bigdata.mapreds.csv;
//package ru.apapikyan.learn.bigdata.mapreds.csv;
//
...
//import org.apache.hadoop.io.TestArrayWritable;
...
//
//public class CSVOutputFormat extends TextOutputFormat<TestArrayWritable, NullWritable> {
//
...
//	}
//
//	protected static class CSVRecordWriter extends RecordWriter<TestArrayWritable, NullWritable> {
...
//
//		@Override
//		public void write(TestArrayWritable key, NullWritable value) throws IOException, InterruptedException {
//			if (key == null) {
//				return;
//			}
//			boolean first = true;
